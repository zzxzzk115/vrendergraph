...
set_config("vrendergraph_root", is_root)
set_config("vrendergraph_project_dir", os.scriptdir())

-- global options
option("vrendergraph_build_examples") -- build examples?
    set_default(true)
    set_showmenu(true)
    set_description("Enable vrendergraph examples")
option_end()
...
if has_config("vrendergraph_build_examples") then
    includes("examples")
end