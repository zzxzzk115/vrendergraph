...
namespace crude_json
{
    ...
    struct value
    {
        ...
        value& operator=(boolean v)
        {
            auto other = value(v);
            swap(other);
            return *this;
        }
        value& operator=(number v)
        {
            auto other = value(v);
            swap(other);
            return *this;
...
#undef CRUDE_MAX2
        ...
        static const boolean* boolean_ptr(const storage_t& storage)
        {
            return reinterpret_cast<const boolean*>(&storage);
        }
        ...
        static type_t construct(storage_t& storage, null)
        {
            (void)storage;
            return type_t::null;
        }
        static type_t construct(storage_t& storage, object&& value)
        {
            new (&storage) object(std::forward<object>(value));
            return type_t::object;
        }
        static type_t construct(storage_t& storage, const object& value)
        {
            new (&storage) object(value);
            return type_t::object;
        }
        static type_t construct(storage_t& storage, array&& value)
        {
            new (&storage) array(std::forward<array>(value));
            return type_t::array;
        }
        static type_t construct(storage_t& storage, const array& value)
        {
            new (&storage) array(value);
            return type_t::array;
        }
        static type_t construct(storage_t& storage, string&& value)
        {
            new (&storage) string(std::forward<string>(value));
            return type_t::string;
        }
        static type_t construct(storage_t& storage, const string& value)
        {
            new (&storage) string(value);
            return type_t::string;
        }
        static type_t construct(storage_t& storage, const char* value)
        {
            new (&storage) string(value);
            return type_t::string;
        }
        static type_t construct(storage_t& storage, boolean value)
        {
            new (&storage) boolean(value);
            return type_t::boolean;
        }
        static type_t construct(storage_t& storage, number value)
        {
            new (&storage) number(value);
        ...
        struct dump_context_t
        {
            ...
            dump_context_t(const int indent, const char indent_char) : indent(indent), indent_char(indent_char) {}
    ...
    template<>
    inline const object* value::get_ptr<object>() const
    {
    ...
    template<>
    inline const array* value::get_ptr<array>() const
    {
    ...
    template<>
    inline const string* value::get_ptr<string>() const
    {
    ...
    template<>
    inline const boolean* value::get_ptr<boolean>() const
    {
    ...
    template<>
    inline const number* value::get_ptr<number>() const
    {
    ...
    template<>
    inline object* value::get_ptr<object>()
    {
        if (m_Type == type_t::object)
            return object_ptr(m_Storage);
        else
    ...
    template<>
    inline array* value::get_ptr<array>()
    {
        if (m_Type == type_t::array)
            return array_ptr(m_Storage);
        else
    ...
    template<>
    inline string* value::get_ptr<string>()
    {
        if (m_Type == type_t::string)
            return string_ptr(m_Storage);
        else
    ...
    template<>
    inline boolean* value::get_ptr<boolean>()
    {
        if (m_Type == type_t::boolean)
            return boolean_ptr(m_Storage);
        else
    ...
    template<>
    inline number* value::get_ptr<number>()
    {
        if (m_Type == type_t::number)
            return number_ptr(m_Storage);
        else
